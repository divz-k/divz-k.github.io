...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/CoverSubmission_MOLECULAR-CELL-D-22-01441R2NaamaBarkai.jpg" title="all that glitters isn't gold" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
